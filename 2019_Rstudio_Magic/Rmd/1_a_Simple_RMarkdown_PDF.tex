...
We'll also introduce another package to help with reproducibility and
sharing work across multiple places or individuals: the \texttt{here}
package.

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{source}\NormalTok{(here}\OperatorTok{::}\KeywordTok{here}\NormalTok{(}\StringTok{"R"}\NormalTok{, }\StringTok{"2_covstatis_example.R"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
