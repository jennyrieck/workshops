---
title: "A whirlwind tour of Rstudio, R, and Rmarkdown Magic for behavioral and brain data science"
...
![](../external/images/setup_1_rstudio_git.PNG){width=75%} 
...
![](../external/images/setup_3_rstudio_project_environ.PNG)
...
* A bit of background, including idiosyncrasies and unique things about R
    * Especially packages & three ways to install (somehwhat covered above)
...
## Part 5: Some advanced/other things we’re not covering
* package development
* Shiny
* SQL
* C/C++
