...
* c, q, t, C, D, F, I, and T (via https://www.johndcook.com/blog/r_language_for_programmers/)
...
* R to Matlab: https://cran.r-project.org/doc/contrib/Hiebeler-matlabR.pdf
* R for programmers: https://www.johndcook.com/blog/r_language_for_programmers/
* RStudio's giant list: https://www.rstudio.com/resources/cheatsheets/
...
* Download R and Rstudio (https://www.rstudio.com/)
...
```{r 0_adnimerge_base, eval=FALSE, echo=TRUE, tidy=FALSE}
library(ADNIMERGE)
...
```{r 1_adnimerge_tidy, eval=FALSE, echo=TRUE, tidy=FALSE}
library(ADNIMERGE)
adnimerge %>%
...
### base R
![](../external/images/create_data_1_base.PNG){width=80%}

### tidyverse

![](../external/images/create_data_2_tidy.PNG){width=80%}
...
![](../external/images/funR_3_wes_anderson.png){width=75%}
