...
\hypertarget{part-2-r}{%
\section{Part 2: R}\label{part-2-r}}
...
\begin{frame}[fragile]{R: factor disasters}
\protect\hypertarget{r-factor-disasters-1}{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a_numeric2character_vector <-}\StringTok{ }\KeywordTok{as.character}\NormalTok{(a_numeric_vector)}

\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(a_numeric2character_vector))}
\end{Highlighting}
\end{Shaded}
