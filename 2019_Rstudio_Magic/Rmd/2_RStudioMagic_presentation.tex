...
Here we dive into our stuff. We show a bit of the code here and there
and explain syntax
...
\begin{frame}{Create data 2 ways:}
\protect\hypertarget{create-data-2-ways}{}

\begin{block}{Base R}

\includegraphics[width=0.8\textwidth,height=\textheight]{../external/images/create_data_1_base.PNG}

\end{block}

\begin{block}{tidyverse}

\includegraphics[width=0.8\textwidth,height=\textheight]{../external/images/create_data_2_tidy.PNG}
